...
import com.universedeveloper.encheotanque.tabs.CidadeTabs;
 ...
 */
public class CidadeFragment extends Fragment implements TabLayout.OnTabSelectedListener, Response.Listener<JSONObject>, Response.ErrorListener, MenuItem.OnMenuItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bundle) {
        ...
        favorito = new Favorito("cidade",cidade,estado);
    ...
    private void tabs() {
        ...
        CidadeTabs adapter = new CidadeTabs(getActivity().getSupportFragmentManager(),this.cidade,this.estado);
